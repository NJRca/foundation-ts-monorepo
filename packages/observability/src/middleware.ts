...
export class ObservabilityMiddleware {
  ...
  private buildConfig(configManager: ConfigManager): ObservabilityConfig {
    return {
 ...
 */
export function createObservabilityMiddleware(configManager: ConfigManager): ObservabilityMiddleware {
 ...
 */
export function createCompleteObservabilitySetup(configManager: ConfigManager) {
