...
exports.CacheHealthCheck =
  exports.DatabaseHealthCheck =
...
const PostgresConnection = /** @class */ (function () {
  ...
  PostgresConnection.prototype.query = function (text, params) {
    return __awaiter(this, void 0, void 0, function () {
      let start, result, duration, error_1;
...
const BaseRepository = /** @class */ (function () {
  function BaseRepository(tableName, db, cache, logger) {
    ...
    this.cache = cache;
    this.logger =
      logger || (0, observability_1.createLogger)(false, 0, ''.concat(tableName, 'Repository'));
  }
  ...
  BaseRepository.prototype.getFromCache = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.cache) return [2 /*return*/, undefined];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
  ...
  BaseRepository.prototype.setInCache = function (id_1, entity_1) {
    return __awaiter(this, arguments, void 0, function (id, entity, ttlSeconds) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.cache) return [2 /*return*/];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
            return [
              4 /*yield*/,
              this.cache.set(this.getCacheKey(id), JSON.stringify(entity), ttlSeconds),
            ];
          case 2:
            _a.sent();
...
const UserRepository = /** @class */ (function (_super) {
  ...
  UserRepository.prototype.findById = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getFromCache(id)];
          case 1:
            cached = _a.sent();
  ...
  UserRepository.prototype.save = function (user) {
    return __awaiter(this, void 0, void 0, function () {
      let now, result, updatedUser, newUser;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            now = new Date();
  ...
  UserRepository.prototype.delete = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.execute('DELETE FROM users WHERE id = $1', [id])];
          case 1:
            _a.sent();
          ...
          case 1:
            ...
            return [
              ...
              users.map(function (user) {
                return _this.transformFromDb(user);
              }),
            ];
        }
      });
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              this.db.query('SELECT MAX(version) as version FROM schema_migrations'),
            ];
          case 1:
            result = _b.sent();
            return [
              2 /*return*/,
              ((_a = result.rows[0]) === null || _a === void 0 ? void 0 : _a.version) || 0,
            ];
        }
      });
    });
  ...
  MigrationRunner.prototype.migrate = function (targetVersion) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.initializeMigrationTable()];
          case 1:
            _a.sent();
          ...
          case 2:
            ...
            migrationsToRun = Array.from(this.migrations.values())
              .filter(function (m) {
                return m.version > currentVersion && m.version <= target;
              })
              .sort(function (a, b) {
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    ...
                    return [
                      4 /*yield*/,
                      this_1.db.transaction(function (client) {
                        return __awaiter(_this, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                            switch (_a.label) {
                              case 0:
                                return [4 /*yield*/, migration.up(this.db)];
                              case 1:
                                _a.sent();
                                return [
                                  4 /*yield*/,
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    ...
                    return [
                      4 /*yield*/,
                      this_2.db.transaction(function (client) {
                        return __awaiter(_this, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                            switch (_a.label) {
                              case 0:
                                return [4 /*yield*/, migration.down(this.db)];
                              case 1:
                                _a.sent();
                                return [
                                  4 /*yield*/,
                                  client.query('DELETE FROM schema_migrations WHERE version = $1', [
                                    migration.version,
                                  ]),
                                ];
                              case 2:
