...
const InMemoryEventStore = /** @class */ (function () {
  ...
  InMemoryEventStore.prototype.saveEvents = function (
    aggregateId,
    aggregateType,
    events,
    expectedVersion
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (expectedVersion !== undefined && existingEvents.length !== expectedVersion) {
              throw new Error(
                'Concurrency conflict. Expected version '
                  .concat(expectedVersion, ', but stream has ')
                  .concat(existingEvents.length, ' events')
              );
            }
            storedEvents = events.map(function (event, index) {
              return {
            ...
            this.events.set(
              streamKey,
              __spreadArray(__spreadArray([], existingEvents, true), storedEvents, true)
            );
            this.logger.info(
              'Saved '
                .concat(events.length, ' events for ')
                .concat(aggregateType, ':')
                .concat(aggregateId),
              {
                aggregateId: aggregateId,
                aggregateType: aggregateType,
        ...
        if (fromVersion !== undefined) {
          return [
            ...
            events.filter(function (event) {
              return event.eventVersion > fromVersion;
            }),
          ];
        }
  ...
  InMemoryEventStore.prototype.loadEventStream = function (aggregateId, aggregateType) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.loadEvents(aggregateId, aggregateType)];
          case 1:
            events = _a.sent();
            if (events.length === 0) {
  ...
  InMemoryEventStore.prototype.saveSnapshot = function (snapshot) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        this.logger.info(
          'Saved snapshot for '.concat(snapshot.aggregateType, ':').concat(snapshot.aggregateId),
          {
  ...
  InMemoryEventStore.prototype.getEventsAfter = function (timestamp, aggregateType) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.getAllEvents(aggregateType)];
          case 1:
            allEvents = _a.sent();
            return [
              2 /*return*/,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            promises = handlers.map(function (handler) {
