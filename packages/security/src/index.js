                    ...
                    case 0:
                        ...
                        if (!session || session.tokenVersion !== payload.tokenVersion) {
                            this.logger.warn('Refresh token references invalid session', {
                                sessionId: payload.sessionId,
                                expectedVersion: session === null || session === void 0 ? void 0 : session.tokenVersion,
...
var AuthorizationService = /** @class */ (function () {
    ...
    AuthorizationService.prototype.matchesPermission = function (permission, resource, action, context) {
